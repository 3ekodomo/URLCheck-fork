...
public class AboutActivity extends Activity {
    ...
    private static final List<Link> LINKS = List.of(
            ...
            new Link(R.string.lnk_fDroid, "https://f-droid.org/packages/com.ekodomo.urlchecker"),
            new Link(R.string.lnk_playStore, "https://play.google.com/store/apps/details?id=com.ekodomo.urlchecker"),
            new Link(R.string.lnk_izzy, "https://apt.izzysoft.de/fdroid/index/apk/com.ekodomo.urlchecker"),
